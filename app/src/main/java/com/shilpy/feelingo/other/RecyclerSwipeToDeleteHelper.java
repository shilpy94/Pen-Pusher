...
public class RecyclerSwipeToDeleteHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public RecyclerSwipeToDeleteHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((NotesRowAdapter.NotelyViewHolder) viewHolder).viewForeground;
